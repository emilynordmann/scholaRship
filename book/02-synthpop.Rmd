...
* Makes a nice looking table using `kable` - note that your table output might look slightly different because the `r pkg("bookdown")` package we use to write this book applies some additional formatting.
