...
If you've worked with R before and have some basic familiarity with how to code in R and how objects and functions work, you should install the packages `r pkg("tidyverse")`,`r pkg("plotly")`, `r pkg("scales")`, and `r pkg("ggpubr")` then skip to the [set-up check](#setup-check) at the end of the chapter.
...
If you type a function into the console pane, it will run as soon as you hit enter. If you put the function in a `r glossary("script")` or `r glossary("R Markdown")` document in the source pane, it won't run until you run the script, `r glossary("knit")` the R Markdown file, or run a code `r glossary("chunk")`. You'll learn more about this in the workshop.
...
- `r pkg("lubridate")` for dates and times
