...
If you've worked with R before and have some basic familiarity with how to code in R and how objects and functions work, you should install the packages `r pkg("tidyverse")`,`r pkg("plotly")`, and `r pkg("ggpubr")` then skip to the [set-up check](#setup-check) at the end of the chapter.
